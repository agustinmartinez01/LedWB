...
public class ledControl extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = newint.getStringExtra(BluetoothActivity.EXTRA_ADDRESS); //recivimos la mac address obtenida en la actividad anterior
    ...
    private void turnOffLed()
    {
        ...
        if (btSocket!=null)
        {
            try
            {
                ...
                btSocket.getOutputStream().write(finalColor.toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void turnOnLed()
    {
        ...
        if (btSocket!=null)
        {
            try
            {
                ...
                btSocket.getOutputStream().write("bluetooth".toString().getBytes());
                btSocket.getOutputStream().write(finalColor.toString().getBytes());
